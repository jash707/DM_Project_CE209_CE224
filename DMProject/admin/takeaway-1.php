...
?>
        ...
        <div class="main-section-categ">
            <div class="main-section-container">
                <div class="heading-title text-center">
                    <h1 style="margin-bottom:0px; font-size: 32px; color: #0cc2bf">Order Your Favourite Dish</h1>
 ...
 <!-- Retieve Menu Details & Cart -->
			...
			if (isset($_POST["add"])){
                ...
                if (isset($_SESSION["cart"])){
					...
					if (!in_array($_GET["id"],$item_array_id)){
						...
						echo '<script>window.location="takeaway-1.php#cart-1"</script>';
					}else{
    ...
    ?>
		<div style="padding-left: 10%;padding-right: 10%; padding-bottom: 5%;" id="cart-1" >
 ...
 <form method="post" action="takeaway-2.php">
	        <div class="col-md-12">
                <div style ="padding-bottom: 5%;" class="submit-button text-center">
                    <input type="submit" class="btn btn-common" id="checkAvability" name="submit" value="Next" />
