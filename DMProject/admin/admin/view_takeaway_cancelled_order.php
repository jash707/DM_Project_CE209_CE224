...
<html>
  ...
  <a class="flex-sm-fill text-sm-center nav-link" href="admin-panel.php">Home</a>
  ...
  <a class="flex-sm-fill text-sm-center nav-link active" href="view_takeaway_cancelled_order.php">Cancelled Order</a>
