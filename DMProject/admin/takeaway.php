	...
	<div class="container">
		<div class="row">
			<div class="col-12">
			    ...
			    <a href="takwaway.php"><i class="fa fa-utensils icon1" style="color: #0cc2bf; border: 2px solid #0cc2bf"></i></a>
        ...
        <div class="main-section-categ">
            <div class="main-section-container">
                <div class="heading-title text-center">
                    <h1 style="margin-bottom:0px; font-size: 32px; color: #0cc2bf">Choose the Food Category</h1>
                ...
                <div class="products wow fadeInRight">
				    ...
				    ?>
		                    <div class="item" style="border-radius:10px; border:1px solid #0cc2bf;">
		                        <div class="imgBx">
		                            <img style="max-width: 100%; max-height: 100%;" src="/admin/<?php echo $r['img']; ?>" />
		                        </div>
		                        <div class="cntBx">
		                            <div class="item-title" style="color : #0cc2bf;"><?php echo $r['name']; ?></div>
	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-6">
					...
					<p class="lead"><a href="tel:8469000683">97239 12479</p>
					<p><a href="mailto:restaurant  @gmail.com"> restaurant  @gmail.com</a></p>
				</div>
				<div class="col-lg-4 col-md-6">
					<h3>Opening hours</h3>
					<p><span class="text-color">Takeaway Timing :</span> 8AM to 11PM</p>
				</div>
			</div>
		</div>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">Rights Reserved. &copy; 2021 </p>
					</div>
				</div>
			</div>
		</div>
